...
void PatternConfig::addHandler() {
    ...
    emit addSignal(x, y, z, state);
}

void PatternConfig::resizeHandler() {
    ...
    emit resizeSignal(depth, height, width);
}